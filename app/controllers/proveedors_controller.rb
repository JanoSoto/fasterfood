class ProveedorsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @proveedor.update(proveedor_params)
        format.html { redirect_to proveedors_url, notice: 'Proveedor actualizado correctamente.' }
  ...
  private
    ...
    def proveedor_params
      params.require(:proveedor).permit(:rut_proveedor, :nombre_proveedor, :telefono_proveedor, :email_proveedor)
    end
end
