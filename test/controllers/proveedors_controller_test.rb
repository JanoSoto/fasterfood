...
class ProveedorsControllerTest < ActionController::TestCase
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post :create, proveedor: { email_proveedor: @proveedor.email_proveedor, nombre_proveedor: @proveedor.nombre_proveedor, rut_proveedor: @proveedor.rut_proveedor, telefono_proveedor: @proveedor.telefono_proveedor }
    end
  ...
  test "should update proveedor" do
    patch :update, id: @proveedor, proveedor: { email_proveedor: @proveedor.email_proveedor, nombre_proveedor: @proveedor.nombre_proveedor, rut_proveedor: @proveedor.rut_proveedor, telefono_proveedor: @proveedor.telefono_proveedor }
    assert_redirected_to proveedor_path(assigns(:proveedor))
  end
